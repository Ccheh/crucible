...
[![Tests](https://img.shields.io/badge/tests-184%2F184%20passing-success)](#)
...
184 forge tests + 7 SDK tests passing
...
- **Pre-audit.** 184 forge tests pass, but no independent security audit. Treat as testnet-only research code.
