...
/// @title  ScalarResolverV8
/// @notice ScalarResolverV7 + **ERC-8004 identity binding** (milestone M2).
...
contract ScalarResolverV8 is IResolver, IResolverFeeReceiver, IResolverSubscriptionReceiver, ReentrancyGuard {
